...
class StreamTest extends TestCase
{
    ...
    public function testGetDimensionsFromAudio()
    {
        ...
        $this->expectExceptionMessage('Dimensions can only be retrieved from video streams.');
    ...
    public function testUnableToGetDimensionsFromVideo($properties)
    {
        ...
        $this->expectExceptionMessage('Unable to extract dimensions.');
    ...
    {
        $stream = new Stream(['codec_type'           => 'video',
                              'width'                => 960,
                              'height'               => 720,
                              'sample_aspect_ratio'  => $invalidRatio,
