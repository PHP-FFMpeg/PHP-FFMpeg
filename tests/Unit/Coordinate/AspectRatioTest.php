...
class AspectRatioTest extends TestCase
{
     ...
     */
    public function testFromDimensions($width, $height, $strategy, $expected, $calculatedWidth, $calculatedHeight, $modulus = 2): void
    {
    ...
    public function provideDimensionsAndExpectedratio(): array
    {
        return [
            //AR_5_4
